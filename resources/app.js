...
window.onload = function () {
  ...
  buttonStart.onclick = function () {
    // the buit-in clearInterval method clears a timer set with setInterval
    // start out with a clean slate:
    clearInterval(Interval);

    // setInterval calls a function - here, startTimer is called every 10 milliseconds
